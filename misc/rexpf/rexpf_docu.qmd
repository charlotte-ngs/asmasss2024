...
### Posit Cloud
The free version of posit cloud has limitations. They can be seen from the posit cloud website. These limitations should not be a problem for what we use the platform in our course.
