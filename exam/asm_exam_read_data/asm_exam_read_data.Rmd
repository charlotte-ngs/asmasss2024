...
### Dataframe
```{r, asm_exam_p1_read_data_df, eval=TRUE, message=FALSE}
...
### Tibble
```{r, asm_exam_p1_read_data_tbl, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
s_data_url_p1 <- file.path(s_data_url_root, "asm_exam_2024_p01.csv")
...
### Dataframe
```{r, asm_exam_p2_read_data_df, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
...
### Tibble
```{r, asm_exam_p2_read_data_tbl, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
s_data_url_p2 <- file.path(s_data_url_root, "asm_exam_2024_p02.csv")
...
### Dataframe
```{r, asm_exam_p3_read_data_df, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
...
### Tibble
```{r, asm_exam_p3_read_data_tbl, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
s_data_url_p3 <- file.path(s_data_url_root, "asm_exam_2024_p03.csv")
...
### Dataframe
```{r, asm_exam_p4_read_data_df, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
...
### Tibble
```{r, asm_exam_p4_read_data_tbl, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
s_data_url_p4 <- file.path(s_data_url_root, "asm_exam_2024_p04.csv")
...
### Dataframe
```{r, asm_exam_p5_read_data_df, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
...
### Tibble
```{r, asm_exam_p5_read_data_tbl, eval=TRUE, message=FALSE}
s_data_url_root <- "https://charlotte-ngs.github.io/asmasss2024/data"
s_data_url_p5 <- file.path(s_data_url_root, "asm_exam_2024_p05.csv")
